...
<template>
  ...
  >
    ...
    <!-- Mobile Dropdown Menu: Absolutely positioned overlay so it floats on top without pushing content below -->
    <Transition
    ...
    >
      <div
        v-if="isMobileMenuOpen"
        class="md:hidden absolute top-full left-0 right-0 w-full bg-white border-t border-neutral-100 px-6 py-4 space-y-4 shadow-xl z-50"
      >
        <RouterLink
          to="/house-design"
          @click="closeMobileMenu"
